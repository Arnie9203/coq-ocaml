...
Theorem ev5_nonsense :
  ev 5 -> 2 + 2 = 9.
Proof.
  intros. inversion H. simpl. inversion H1. inversion H3. Qed.
...
Proof.
  intros. induction H0.
  + simpl in H. apply H.
  + simpl in H. apply IHev. inversion H. apply H2.
  Qed.
(** [] *)
...
Theorem empty_relation_is_empty : forall n m, ~ empty_relation n m.
  Proof. intros. unfold not. intros. inversion H. subst. apply H0. Qed.
